...
export default async function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-300 p-8">
        ...
        <div className="rounded-lg bg-white p-8 shadow">
          {session ? (
            ...
            <div className="space-y-6 text-center">
              <div>
                <h2 className="text-2xl font-semibold text-gray-900">
                  Test application for AuthManager service
                </h2>
                <p className="mt-2 text-gray-600">
                  Sign in to access your account and manage tokens/tasks
                </p>
              </div>
              <SignInButton />
            </div>
